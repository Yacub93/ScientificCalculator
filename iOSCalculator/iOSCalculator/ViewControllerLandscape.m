...
@interface ViewControllerLandscape ()
@property (strong, nonatomic)NSString *resultText;
@end

@implementation ViewControllerLandscape : UIViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if ([segue.identifier isEqualToString:@"tapeViewControllerLandscape"]) {
        
        ViewControllerLandscape *switchViewcontroller = segue.destinationViewController;
